...
const config = {
  ...
  DD_API_KEY: auth.DD_API_KEY || process.env.DD_API_KEY || '',
  DD_SECRET_KEY: auth.DD_SECRET_KEY || process.env.DD_SECRET_KEY || '',
  DD_HTTP_PROXY: auth.DD_HTTP_PROXY || process.env.DD_HTTP_PROXY || '',
